...
interface AddStudentModalProps {
  ...
  onStudentAdded: () => void;
  groups: Group[];
  selectedGroupId?: string; // Add selected group ID prop
}
...
const AddStudentModal: React.FC<AddStudentModalProps> = ({
  ...
  useEffect(() => {
    if (!isOpen) {
      ...
      // Auto-fill group when modal opens if a group is selected
          ...
          <div style={{ padding: '1.5rem', maxHeight: '60vh', overflowY: 'auto' }}>
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <select
                ...
                onBlur={(e) => e.target.style.borderColor = '#ddd'}
              >
                <option value="">Без группы (индивидуальный ученик)</option>
                {groups.map(group => (
              ...
              <div style={{
                ...
                Можно оставить без группы для индивидуальных учеников
              </div>
            </div>
